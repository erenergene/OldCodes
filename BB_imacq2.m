...
%% Select Spot
Spot_no = SelectSpot(cell2mat(tifR(:,:,:,1)))
...
[R_Crop_Bothnm{1,:},x_crop_Bothnm,y_crop_Bothnm] = AreaSelection_Circle(cell2mat(tifR(:,:,:,1)));
G_Crop_Bothnm{1,:} = AreaSelection_Circle_Mod(cell2mat(tifG(:,:,:,1)),x_crop_Bothnm,y_crop_Bothnm);
B_Crop_Bothnm{1,:} = AreaSelection_Circle_Mod(cell2mat(tifB(:,:,:,1)),x_crop_Bothnm,y_crop_Bothnm);
%%
tic
for i = 2:nfiles
  R_Crop_Bothnm{i,:} = AreaSelection_Circle_Mod(cell2mat(tifR(:,:,:,i)),x_crop_Bothnm,y_crop_Bothnm);
  G_Crop_Bothnm{i,:} = AreaSelection_Circle_Mod(cell2mat(tifG(:,:,:,i)),x_crop_Bothnm,y_crop_Bothnm);
  B_Crop_Bothnm{i,:} = AreaSelection_Circle_Mod(cell2mat(tifB(:,:,:,i)),x_crop_Bothnm,y_crop_Bothnm);
  fprintf("Running %.0f\n",i)
timebothnm = toc
end
