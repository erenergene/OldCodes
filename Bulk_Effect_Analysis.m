...
for j = 1:numel(L)
[Gamma1_n_1(i,j),Z1_n_1(i,j)] = multidiel1([1;nrSiO(1,i);nrSi(1,i)],L(j).*nrSiO(1,i),lambda(1,i));    
[Gamma1_n_1_33(i,j),Z1_n_1_33(i,j)] = multidiel1([1.33;nrSiO(1,i);nrSi(1,i)],L(j).*nrSiO(1,i),lambda(1,i));
[Gamma1_n_1_34(i,j),Z1_n_1_34(i,j)] = multidiel1([1.34;nrSiO(1,i);nrSi(1,i)],L(j).*nrSiO(1,i),lambda(1,i));
end
end

%% USING DIFFERENT MULTIDIEL

% for i = 1:numel(lambda)
% for j = 1:numel(L)
% [Gamma1_n_1(i,j),Z1_n_1(i,j)] = multidiel([1;nrSiO(1,i);nrSi(1,i)],L(j).*nrSiO(1,i),lambda(1,i));    
% [Gamma1_n_1_33(i,j),Z1_n_1_33(i,j)] = multidiel([1.33;nrSiO(1,i);nrSi(1,i)],L(j).*nrSiO(1,i),lambda(1,i));
% [Gamma1_n_1_34(i,j),Z1_n_1_34(i,j)] = multidiel([1.34;nrSiO(1,i);nrSi(1,i)],L(j).*nrSiO(1,i),lambda(1,i));
% end
% end

%% USING DIFFERENT MULTIDIEL ENDS
