% Si_SiO2_Simulation_copy.m - Silicon/Silicon Dioxide Simulations (valtoindex different version)
...
hold on
plot(L,Gamma(valtoindex(0.46, numval, lambda(1), lambda(end)),:),'b','LineWidth',2) %Reflectivity curve at 460 nm (blue)
plot(L,Gamma(valtoindex(0.53, numval, lambda(1), lambda(end)),:),'g','LineWidth',2) %Reflectivity curve at 530 nm (green)
plot(L,Gamma(valtoindex(0.625, numval, lambda(1), lambda(end)),:),'r','LineWidth',2) %Reflectivity curve at 625 nm (red)
...
Ref_at_blue = reflectivity_curve_0nm(valtoindex(cw_b, numval, lambda(1), lambda(end))); %Reflectivity at blue (455 nm)
Ref_at_green = reflectivity_curve_0nm(valtoindex(cw_g, numval, lambda(1), lambda(end))); %Reflectivity at green (521.2 nm)
Ref_at_red = reflectivity_curve_0nm(valtoindex(cw_r, numval, lambda(1), lambda(end))); %Reflectivity at red (634.2 nm)
...
Gamma_B = Gamma/Gamma_Si(valtoindex(cw_b, numval, lambda(1), lambda(end)));
Gamma_G = Gamma/Gamma_Si(valtoindex(cw_g, numval, lambda(1), lambda(end)));
Gamma_R = Gamma/Gamma_Si(valtoindex(cw_r, numval, lambda(1), lambda(end)));

Ref_at_0nm_R = Gamma(valtoindex(cw_r, numval, lambda(1), lambda(end)),valtoindex(0, numval, L(1), L(end)));
Ref_at_0nm_G = Gamma(valtoindex(cw_g, numval, lambda(1), lambda(end)),valtoindex(0, numval, L(1), L(end)));
Ref_at_0nm_B = Gamma(valtoindex(cw_b, numval, lambda(1), lambda(end)),valtoindex(0, numval, L(1), L(end)));
Ref_at_120nm_R = Gamma(valtoindex(cw_r, numval, lambda(1), lambda(end)),valtoindex(0.12, numval, L(1), L(end)));
Ref_at_120nm_G = Gamma(valtoindex(cw_g, numval, lambda(1), lambda(end)),valtoindex(0.12, numval, L(1), L(end)));
Ref_at_120nm_B = Gamma(valtoindex(cw_b, numval, lambda(1), lambda(end)),valtoindex(0.12, numval, L(1), L(end)));
