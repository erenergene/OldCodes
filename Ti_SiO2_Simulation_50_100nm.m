% Ti_SiO2_Simulation_50_100nm - Silicon Dioxide on Titanium Simulations
...
L_Ti = linspace(0.05,0.1,2655); %Un/comment for L = 50-100 nm
...
xticklabels([0.05 0.0571 0.0643 0.0714 0.0785 0.0856 0.0927 0.1]) %Un/comment for L = 50-100 nm
ylim([0.05 0.1]) %Un/comment for L = 50-100 nm
yticks([0.05 0.0571 0.0643 0.0714 0.0785 0.0856 0.0927 0.1]) %Un/comment for L = 50-100 nm
