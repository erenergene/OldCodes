% reftocurve.m - Reflectance Curve Fitting
...
avg_L_Diff = mean(L_Diff,2); %average of R,G,B differences at each thickness
est_in = find(avg_L_Diff == min(avg_L_Diff)); %find index of minimum difference
